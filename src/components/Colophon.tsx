...
export function Colophon() {
  const rows: [string, string][] = [
    ...
    ['Live track', 'MyShipTracking AIS (terrestrial) · basemap CARTO / OpenStreetMap'],
  ]
  ...
  return (
    <footer className="border-t border-rule-2 px-md py-md">
      ...
      <p className="mt-sm max-w-[70ch] font-mono text-[10px] leading-relaxed text-muted">
        ...
        port; sea-day positions are interpolated, not observed — switch the chart to Live AIS
        for the real fix, when she&rsquo;s close enough to shore for it.
      </p>
    </footer>
  )
}
